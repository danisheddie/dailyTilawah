...
const en = {
  ...
  'home.welcomeBack': 'Welcome back. Pick up wherever you left off.',
  'home.streakKept': 'We kept your streak — read today to keep it going.',
  'home.streakKeptShort': 'Streak kept',
  'home.lastReadToday': 'Last read today',
  'home.lastReadYesterday': 'Last read yesterday',
  'home.lastReadDaysAgo': 'Last read {n} days ago',
  ...
  'nav.more': 'More',
  'saved.title': 'Saved',
  'saved.subtitle': 'Your bookmarked pages',
  'saved.empty': 'No saved pages yet. Tap the bookmark on any page while reading to keep it here.',
  'saved.browse': 'Open the Qur’an',
  ...
  'reader.undo': 'Undo',
  'reader.undoMistake': 'Marked by mistake? Undo',
  'reader.read': 'Read',
  'reader.next': 'Next',
  'reader.playPage': 'Play this page',
  'reader.pausePage': 'Pause recitation',
  ...
  'jump.goToPage': 'Go to page {page}',
  'home.search': 'Search surah or page',
  'home.searchQuran': 'Search the Quran',
  'home.completed': 'Completed',
  'home.currentStreak': 'Current streak',
  'home.pagesRead': 'pages read',
  ...
  'settings.readingActivity': 'Reading activity',
...
const ms = {
  ...
  'home.welcomeBack': 'Selamat kembali. Sambung dari mana anda berhenti.',
  'home.streakKept': 'Kami kekalkan rentetan anda — baca hari ini untuk meneruskannya.',
  'home.streakKeptShort': 'Rentetan dikekalkan',
  'home.lastReadToday': 'Kali terakhir dibaca hari ini',
  'home.lastReadYesterday': 'Kali terakhir dibaca semalam',
  'home.lastReadDaysAgo': 'Kali terakhir dibaca {n} hari lalu',
  'home.todayGoal': 'Sasaran hari ini',
  'home.todaysReading': 'Bacaan hari ini',
  ...
  'saved.subtitle': 'Halaman yang anda tanda',
  'saved.empty': 'Belum ada halaman disimpan. Ketik ikon tanda buku semasa membaca untuk menyimpannya di sini.',
  'saved.browse': 'Buka al-Quran',
  ...
  'reader.marked': 'Ditanda sebagai dibaca',
  'reader.undo': 'Buat asal',
  'reader.undoMistake': 'Tersilap tanda? Buat asal',
  'reader.read': 'Dibaca',
  'reader.next': 'Seterusnya',
  'reader.playPage': 'Mainkan halaman ini',
  'reader.pausePage': 'Jeda bacaan',
  'reader.options': 'Pilihan bacaan',
  'reader.pageOf': 'Halaman {page} daripada {total}',
  'reader.listen': 'Dengar',
  'reader.pause': 'Jeda',
  'reader.more': 'Lagi',
  ...
  'jump.goToPage': 'Pergi ke halaman {page}',
  'home.search': 'Cari surah atau halaman',
  'home.searchQuran': 'Cari al-Quran',
  'home.completed': 'Selesai',
  'home.currentStreak': 'Rentetan semasa',
  'home.pagesRead': 'halaman dibaca',
  'home.lifetime': '(keseluruhan)',
  ...
  'settings.readingActivity': 'Aktiviti bacaan',
...
const id = {
  ...
  'home.welcomeBack': 'Selamat datang kembali. Lanjutkan dari tempat Anda berhenti.',
  'home.streakKept': 'Kami menjaga rentetan Anda — baca hari ini untuk melanjutkannya.',
  'home.streakKeptShort': 'Rentetan dijaga',
  'home.lastReadToday': 'Terakhir dibaca hari ini',
  'home.lastReadYesterday': 'Terakhir dibaca kemarin',
  'home.lastReadDaysAgo': 'Terakhir dibaca {n} hari lalu',
  ...
  'saved.subtitle': 'Halaman yang Anda tandai',
  'saved.empty': 'Belum ada halaman tersimpan. Ketuk ikon markah saat membaca untuk menyimpannya di sini.',
  'saved.browse': 'Buka Al-Qur’an',
  ...
  'reader.prev': 'Sebelum',
  'reader.markRead': 'Tandai dibaca',
  'reader.marked': 'Ditandai sebagai dibaca',
  'reader.undo': 'Urungkan',
  'reader.undoMistake': 'Salah tandai? Urungkan',
  'reader.read': 'Dibaca',
  'reader.next': 'Berikutnya',
  'reader.playPage': 'Putar halaman ini',
  'reader.pausePage': 'Jeda bacaan',
  'reader.options': 'Opsi bacaan',
  ...
  'jump.goToPage': 'Buka halaman {page}',
  'home.search': 'Cari surah atau halaman',
  'home.searchQuran': 'Cari Al-Qur’an',
  'home.completed': 'Selesai',
  'home.currentStreak': 'Rentetan saat ini',
  'home.pagesRead': 'halaman dibaca',
  'home.lifetime': '(keseluruhan)',
  'home.readToday': 'Dibaca hari ini',
  'journey.title': 'Perjalanan Anda',
  ...
  'settings.readingActivity': 'Aktivitas bacaan',
