  ...
  return (
    ...
    >
      ...
      {!loading && !error && dataReady && !completion && (
        <div className="pointer-events-none fixed inset-x-0 bottom-0 mx-auto max-w-2xl bg-gradient-to-t from-paper via-paper/90 to-transparent px-5 pb-[max(1.75rem,calc(env(safe-area-inset-bottom)+0.5rem))] pt-10">
